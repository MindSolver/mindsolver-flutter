          ...
          children: [
              ...
              calendarBuilders: CalendarBuilders(
                selectedBuilder: (context, date, events) => Container(
                  ...
                  decoration: BoxDecoration(
                    color: customColor
                        .kpurpleColor, // Change to your custom selected color
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: customColor
                      .kpurpleDarkerColor, // Change to your custom color
                ...
                child: TextButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const WriteTemplate(), // Replace OtherPage() with the desired widget for the other page
                      ),
                    );
                  },
                  child: const Center(
